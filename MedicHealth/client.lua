    ...
    while true do
        ...
        for _,location in ipairs(positions) do
            ...
            if position_verf(playerLoc.x, playerLoc.y, playerLoc.z, x, y, z, 2) then
                help_message("Paina ~INPUT_CONTEXT~ kirjautukaksesi osastolle.")
                if IsControlJustReleased(1, presskey) then
                    FreezeEntityPosition(GetPlayerPed(-1), true)
                    notify_message("~g~Päätit mennä osastolle.")
                    ...
                    SetTimeout(7000, function()
                        ...
                        SetTimeout(500, function()
                            ...
                            SetTimeout(1500, function()
                                DoScreenFadeIn(500)
                                notify_message("~g~Lepäät osastolla.")
                                DrawSpecialText("Lepäät osastolla.", 120000)
                                SetTimeout(120000, function()
                                    notify_message("~g~Olet nyt vapaa lähtemään.")
